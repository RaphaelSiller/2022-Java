...
import javax.swing.JFrame;
	...
	public void paint(Graphics g) {
		...
		for (double i = WELT_X0; i < WELT_X1; i+=0.01) {
			...
			g.drawLine(umrechnungX(i), umrechnungY(Math.cos(i)), umrechnungX(i+0.01), umrechnungY(Math.cos(i+0.01)));
		}
    }
