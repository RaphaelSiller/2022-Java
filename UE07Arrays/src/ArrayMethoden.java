public class ArrayMethoden {
	...
	/**
	 * Erstellt ein neues Array mit der Größe anzahl. Die einzelnen Elemente werden
	 * mit Zufallszahlen zwischen von und bis gefüllt.
	 * 
	 * @param int
	 *            anzahl Die Größe des neuen Arrays
	 * @param von
	 *            Der kleinste Wert, welcher im Array vorkommen kann.
	 * @param bis
	 *            Der größte Wert, welcher im Array vorkommen kann.
	...
	/**
	 * Gibt den übergebenen String in der Konsole aus. Die Ausgabe erfolgt in der
	...
	/**
	 * Gibt den kleinsten Wert des übergebenen Arrays zurück.
	 * 
	 * @param int[]
	 *            a das übergebene Array.
	 * @return der kleinste Wert des übergebenen Array a[].
	 */
	...
	/**
	 * Gibt den kleinsten Wert des übergebenen Arrays, ab pos, zurück.
	 * 
	 * @param int[]
	 *            a das übergebene Array.
	 * @param int
	...
	/**
	 * Gibt den größten Wert des übergebenen Arrays zurück.
	 * 
	 * @param int[]
	 *            a das übergebene Array.
	 * @return der größte Wert des übergebenen Array a[].
	 */
	...
	/**
	 * Gibt den Mittelwert des übergebenen Arrays zurück.
	 * 
	 * @param int[]
	 *            a das übergebene Array.
	 * @return der Mittelwert des übergebenen Array a[].
	 */
	...
	/**
	 * Gibt den Index des ersten Elements mit der Zahl z zurück.
	 * 
	 * @param int[]
	 *            a das übergebene Array
	 * @param int
	...
	/**
	 * Gibt den Index des ersten Elements mit der Zahl z zurück. Die Suche startet
	...
	/**
	 * Gibt die kleinste Zahl des übergebenene Arrays, ab pos, zurück. Index pos
	...
	public static int[] delDoppelte(int[] a) {
		// Vorgängerversion, wo 0 nicht mitgenommen wird
		//
		// int[] aClone = a.clone();
		// int[] ret;
		// int zeroCounter = 0;
		...
		// zeroCounter++;
		// }
		// //Das Array mit 0 in ein kleineres Array geben, welches keine 0 enthält
		...
		//Es wird die Anzahl der Doppelten gezählt, damit ret kleiner ist
